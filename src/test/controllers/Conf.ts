...
export const FULLQUERY_WHOIS_BILLSMITH = {
    "source": "agent",
...
export const GENERAL_WHAT_AGENT_IS_THIS_EXPECTED = {
...
export const EXPECTEDRESPONSE_WHOIS_POTUS = {
    "version": "",
    "success": true,
...
export const EXPECTEDRESPONSE_WHOIS_POTUS_DEV = {
    "version": "",
    "success": true,
    "userInput": "who is the president of the usa",
...
export const EXPECTEDRESPONSE_WHOIS_FASTESTMAN ={
    "version": "",
    "success": true,
...
export const EXPECTEDRESPONSE_WHATIS_CHAIR = {
    "version": "",
    "success": true,
...
export const WOLFRAM_FULL_KNOWLEDGE_RESULT = {
    'source': 'agent',
    'resolvedQuery': 'who is albert einstein',
    'action': 'knowledge',
    'actionIncomplete': false,
...
export const WIKI_KNOWLEDGE_RESULT = {
    'source': 'agent',
...
export const WOLFRAM_SIMPLE_KNOWLEDGE_RESULT = {
    'source': 'agent',
...
export const GENERAL_WHAT_AGENT_IS_THIS =   {
    "contexts": [],
    "lang": "en",
...
export const YELP_FALLBACK_RESULT = {
    'source': 'agent',
...
export const YELP_FALLBACK_RESPONSE = {
    "speech": "Whoops, I don't think I heard you.",
...
export const IMAGE_SEARCH_RESULT = {
    'source': 'agent',
...
export const BING_KNOWLEDGE_RESULT = {
    'source': 'agent',
    'resolvedQuery': 'who is donald trump?',
    'action': 'bing',
    'actionIncomplete': false,
...
export const WRONG_INTENT_KNOWLEDGE_RESULT = {
