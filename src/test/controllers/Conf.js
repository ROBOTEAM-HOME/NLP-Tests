...
exports.EXPECTEDRESPONSE_WHOIS_MADONNA = [{
        "version": "",
        "success": true,
...
exports.EXPECTEDRESPONSE_WHOIS_MADONNA_DEV = [{
        "version": "",
        "success": true,
        "userInput": "who is madonna",
        "spokenResult": "Here's some info for you: ",
...
exports.CURRENCY_CONVERTER_RESULT = {
    'source': 'agent',
    'resolvedQuery': 'convert 13 dollar to euro',
    'action': 'knowledge',
    'actionIncomplete': false,
    'parameters': {
        'convert_from': 'USD',
        'convert_to': 'EUR',
        'number': 13,
        'knowledge': 'converter.currency',
    },
    'contexts': [],
    'metadata': {
        'intentId': 'a896db1b-5523-4871-9371-9522dd3def00',
        'webhookUsed': 'false',
        'webhookForSlotFillingUsed': 'false',
        'intentName': 'Converter:currency',
    },
    'score': 1,
};
exports.DISTANCE_CONVERTER_RESULT = {
    'source': 'agent',
