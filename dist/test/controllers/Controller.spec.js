...
describe('Compare known knowledge results', function () {
    ...
    it('Who is Albert Einstein', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(15000);
            const response = yield test_func(conf.FULLQUERY_WHOIS_ALBERTEINSTEIN);
    ...
    it('Who is President of the United States', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(15000);
            const response = yield test_func(conf.FULLQUERY_WHOIS_POTUS);
    ...
    it('Who is the fastest man in the world', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(15000);
            const response = yield test_func(conf.FULLQUERY_WHOIS_FASTESTMAN);
    ...
    it('What\'s the distance from tokyo to new york in kilometers', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(15000);
            const response = yield test_func(conf.FULLQUERY_DISTANCEFROMATOB);
    ...
    it('Who is Bill Smith', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(15000);
            const response = yield test_func(conf.FULLQUERY_WHOIS_BILLSMITH);
            const wolframResponse = response.split('\n').splice(0, 2).map(JSON.parse).map(removeVersionNumber);
    ...
    it('What is a chair', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(15000);
            const response = yield test_func(conf.FULLQUERY_WHATIS_CHAIR);
    ...
    it('What is coca-cola', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(15000);
            const response = yield test_func(conf.FULLQUERY_WHATIS_COCACOLA);
